        ...
        <div className="card">
          ...
          {(state === 'ready' || state === 'accepting') && (
            <>
              ...
              <div className="card-title">Te invitaron a unirse</div>
              <div className="card-sub">Vas a ser parte de la organización:</div>
              <div className="org-badge">🏢 {orgName}</div>
              {inviteEmail && (
          ...
          {state === 'needsLogin' && (
            <>
              ...
              <div className="card-sub">Necesitás iniciar sesión o crear una cuenta para aceptar esta invitación.</div>
              {inviteEmail && (
                <div className="info-box">

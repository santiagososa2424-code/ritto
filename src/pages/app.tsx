...
export default function AppPage() {
  ...
  const now = new Date();
  const thisMonth = done.filter((inv) => {
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .spinner {
          ...
          border: 2px solid rgba(10,124,89,0.3); border-top-color: var(--green);
        ...
        thead th {
          text-align: left; padding: 10px 13px; color: var(--gray); font-weight: 500;
        ...
        <div className="page-wrap">
          ...
          <div className="stats-row">
            ...
            <div className="stat-card">
              ...
              <div className={`stat-value${totalAmount > 999999 ? ' stat-value-sm' : ''}`}>
          ...
          <div className="section-header">
            ...
            {done.length > 0 && (
              <span className="count-badge">{done.length} factura{done.length !== 1 ? 's' : ''}</span>
            )}
          </div>
